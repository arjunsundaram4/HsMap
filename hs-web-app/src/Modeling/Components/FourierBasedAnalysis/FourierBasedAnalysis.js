  ...
  render() {
      return (
          <div className={"modelContent"}>
              ...
              <h2 className={"title"}>COVID-19 Data Spectral Analysis</h2>
              <p>
              ...
              <h2 className={"title"}>Sample of Fourier-based analysis</h2>
              ...
              <p >By looking at the curve of reported cases, we see the two bumps in cases, the first bump being due to the initial cases, and the second bump, several months later, corresponds to the winter outbreak.  This would tend to cause the DFT to report a frequency corresponding to a period of about half a year and a period of about a year.  We can also see higher harmonics.</p>
              <p >Finally, we have a few limitations that present themselves:
                  <ul>
